...
<head>
    ...
    <link rel="icon" href="<?= URL ?>public/assets/images/logo.png">
...
<body>
    ...
    <header>
        <a class="log_and_name" href="<?= URL ?>search">
            <img class="logo_img" src="<?= URL ?>public/assets/images/logo.svg" alt="logo">
        ...
        <div class="buttons_icons">
            ...
            <a class="button" href="<?= URL ?>logout">
                <img class="log_out_img" src="<?= URL ?>public/assets/images/log-out.svg" alt="log out icon">
            </a>
        </div>
